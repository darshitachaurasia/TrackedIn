      ...
      <main className="px-6 py-20">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            A modern, AI-powered productivity tracker to help you stay consistent, 
            motivated, and showcase your daily wins with ease.
          </p>
          <SignUpButton mode="modal">
            <button className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-lg font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all transform hover:scale-105">
              Start Your Journey
            </button>
          </SignUpButton>
        </div>
        ...
        <div className="max-w-6xl mx-auto mt-20 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">Set and track your daily objectives with ease</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-lg">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">Share your progress on LinkedIn automatically</p>
          </div>
        </div>
      </main>
    </div>
